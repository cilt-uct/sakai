...
import { createPopper } from "./assets/@popperjs/core/lib/popper.js?version=9c647cc0";
...
export class SakaiOptionsMenu extends LitElement {
  static get properties() {
    return {
      placement: String,
      invokerSize: {
        attribute: "invoker-size",
        type: String
      },
      invokerTooltip: {
        attribute: "invoker-tooltip",
        type: String
      }
    };
  }
  ...
  _toggle() {
    if (this.showing) {
      ...
      this.content.style.visibility = "visible"; //this.content.querySelector("a").focus();
    }
