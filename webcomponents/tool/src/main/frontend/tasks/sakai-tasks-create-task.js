...
import { SakaiDialogContent } from "../sakai-dialog-content.js?version=9c647cc0";
import "../datepicker/sakai-date-picker.js?version=9c647cc0";
...
export class SakaiTasksCreateTask extends SakaiDialogContent {
    ...
    return html`
      ...
      <div id="due-and-priority-block">
        <div id="due-block">
          ...
          <div class="input">
            <sakai-date-picker id="due" @datetime-selected=${e => {
      this.task.due = e.detail.epochMillis;
      this.dueUpdated = true;
    }} epoch-millis=${this.task.due}></sakai-date-picker>
          </div>
        </div>
        <div id="spacer"></div>
  ...
  static get styles() {
    return [SakaiDialogContent.styles, css`
