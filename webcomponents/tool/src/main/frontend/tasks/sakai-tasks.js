import { css, html } from "../assets/lit-element/lit-element.js?version=9c647cc0";
import { unsafeHTML } from "../assets/lit-html/directives/unsafe-html.js?version=9c647cc0";
import { SakaiPageableElement } from "../sakai-pageable-element.js?version=9c647cc0";
import "../sakai-icon.js?version=9c647cc0";
import moment from "../assets/moment/dist/moment.js?version=9c647cc0";
import "../assets/@lion/dialog/lion-dialog.js?version=9c647cc0";
import "./sakai-tasks-create-task.js?version=9c647cc0";
import "../sakai-editor.js?version=9c647cc0";
export class SakaiTasks extends SakaiPageableElement {
  ...
  set data(value) {
    ...
    this._data = value; // Show highest priority tasks first
