...
import { icon, library } from "./assets/@fortawesome/fontawesome-svg-core/index.es.js?version=9c647cc0";
import { faStar, faEllipsisV, faBell, faTimes, faCheckSquare, faComments, faBook, faFile, faFileAlt, faGripVertical, faMinus, faPlus, faFlag, faAngleRight, faAngleLeft, faHourglass, faFileWord, faSync, faTrash, faTrashRestore, faEdit, faArrowDown, faArrowLeft, faArrowRight, faArrowUp, faCompressArrowsAlt, faExpandArrowsAlt } from "./assets/@fortawesome/free-solid-svg-icons/index.es.js?version=9c647cc0";
...
SakaiIcon.lookups.set("close", faTimes); //SakaiIcon.lookups.set("close", faTimesCircle);
