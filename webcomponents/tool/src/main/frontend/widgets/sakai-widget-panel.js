import { html, css, LitElement } from "../assets/lit-element/lit-element.js?version=9c647cc0";
import { ifDefined } from "../assets/lit-html/directives/if-defined.js?version=9c647cc0";
import { repeat } from "../assets/lit-html/directives/repeat.js?version=9c647cc0";
import "./sakai-dashboard-widget.js?version=9c647cc0";
import "./sakai-calendar-widget.js?version=9c647cc0";
import "./sakai-tasks-widget.js?version=9c647cc0";
import "./sakai-grades-widget.js?version=9c647cc0";
import "./sakai-announcements-widget.js?version=9c647cc0";
import "./sakai-forums-widget.js?version=9c647cc0";
import "./sakai-widget-picker.js?version=9c647cc0";
...
export class SakaiWidgetPanel extends LitElement {
  ...
  changeState(state) {
    ...
    if (this.state === "add") {
      this.widgets.forEach(w => w.state = "view"); // Add in the picker widget
      ...
      this.updateComplete.then(() => {
        ...
        picker.setAttribute("state", "remove"); // After a widget's been picked
