...
import "./sakai-options-menu.js?version=9c647cc0";
  ...
  _toggleFavourite(e) {
    ...
    fetch(url).then(r => {
      if (r.ok) {
        ...
        this.requestUpdate();
        this.dispatchEvent(new CustomEvent(e.target.checked ? "favourited" : "unfavourited", {
          detail: {
            id: this._courseData.id
          },
          bubbles: true
        }));
      } else {
