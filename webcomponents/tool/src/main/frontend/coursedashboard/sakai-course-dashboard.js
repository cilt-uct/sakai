import { html, LitElement } from "../assets/lit-element/lit-element.js?version=9c647cc0";
import { loadProperties } from "../sakai-i18n.js?version=9c647cc0";
import "../widgets/sakai-widget-panel.js?version=9c647cc0";
import "../assets/@lion/dialog/lion-dialog.js?version=9c647cc0";
import "./sakai-course-dashboard-template-picker.js?version=9c647cc0";
import "./sakai-course-header.js?version=9c647cc0";
import "./sakai-course-overview.js?version=9c647cc0";
export class SakaiCourseDashboard extends LitElement {
  ...
  loadData() {
    ...
    }).then(r => this.data = r).catch(error => console.error(error));
  }
