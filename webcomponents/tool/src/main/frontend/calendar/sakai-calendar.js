import { html, css } from "../assets/lit-element/lit-element.js?version=9c647cc0";
import { ifDefined } from "../assets/lit-html/directives/if-defined.js?version=9c647cc0";
import "./sakai-calendar-create-event.js?version=9c647cc0";
import "./sakai-calendar-display-event.js?version=9c647cc0";
import { LionCalendar } from "../assets/@lion/calendar/src/LionCalendar.js?version=9c647cc0";
...
export class SakaiCalendar extends LionCalendar {
  ...
  loadData() {
    const url = this.siteId ? `/api/sites/${this.siteId}/calendar` : `/api/users/${this.userId}/calendar`;
    fetch(url, {
      cache: "no-cache",
