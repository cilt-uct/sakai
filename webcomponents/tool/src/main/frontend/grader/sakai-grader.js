import { SakaiElement } from "/webcomponents/sakai-element.js?version=9c647cc0";
import { html } from "/webcomponents/assets/lit-element/lit-element.js?version=9c647cc0";
import { unsafeHTML } from "/webcomponents/assets/lit-html/directives/unsafe-html.js?version=9c647cc0";
import "/webcomponents/fa-icon.js?version=9c647cc0";
import "./sakai-grader-file-picker.js?version=9c647cc0";
import "../sakai-date-picker.js?version=9c647cc0";
import "../sakai-group-picker.js?version=9c647cc0";
import "../sakai-document-viewer.js?version=9c647cc0";
import "../sakai-lti-iframe.js?version=9c647cc0";
import { gradableDataMixin } from "./sakai-gradable-data-mixin.js?version=9c647cc0";
import { Submission } from "./submission.js?version=9c647cc0";
import "/webcomponents/rubrics/rubric-association-requirements.js?version=9c647cc0";
import "/webcomponents/rubrics/sakai-rubric-grading-button.js?version=9c647cc0";
export class SakaiGrader extends gradableDataMixin(SakaiElement) {
  ...
  canNavigate() {
    ...
    return this.modified || nFiles > 0 ? confirm(this.i18n["confirm_discard_changes"]) ? this.clearSubmission() : false : true;
  }
