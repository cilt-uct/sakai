...
import { html } from "../assets/lit-html/lit-html.js?version=9c647cc0";
import { getViewPreferences, updateViewPreferences } from "../sakai-view-preferences.js?version=9c647cc0";
export class GraderToggle extends SakaiElement {
  ...
  static get properties() {
    return {
      checked: Boolean,
      uncheckedByDefault: {
        attribute: "unchecked-by-default",
        type: Boolean
      },
      i18n: Object,
      tool: String
