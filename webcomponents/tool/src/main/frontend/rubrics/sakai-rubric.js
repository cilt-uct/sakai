...
import "./sakai-rubric-criteria.js?version=9c647cc0";
import "./sakai-rubric-criteria-readonly.js?version=9c647cc0";
import "./sakai-rubric-edit.js?version=9c647cc0";
import "./sakai-item-delete.js?version=9c647cc0";
import "./sakai-rubric-site-title.js?version=9c647cc0";
import "./sakai-rubric-modified-date.js?version=9c647cc0";
import "./sakai-rubric-creator-name.js?version=9c647cc0";
import { tr } from "./sakai-rubrics-language.js?version=9c647cc0";
import { SharingChangeEvent } from "./sharing-change-event.js?version=9c647cc0";
export class SakaiRubric extends RubricsElement {
    ...
    return html`
      <div class="rubric-title" @click="${this.toggleRubric}">
        <div>
          ...
          ${this.rubric.metadata.locked ? html`<span tabindex="0" role="display" title="${this.rubric.title} ${tr("is_locked")}" class="locked fa fa-lock"></span>` : html`<sakai-rubric-edit @show-tooltip="${this.showToolTip}" @update-rubric-title="${this.updateRubricTitle}" rubric="${JSON.stringify(this.rubric)}" token="${this.token}"></sakai-rubric-edit>`}
        </div>
        ...
        <div class="actions">
          ${!this.rubric.metadata.locked ? html`
            <div class="action-container">
              <span class="hidden-sm hidden-xs sr-only">
                ${this.rubric.weighted ? html`<sr-lang key="weighted_label">weighted_label</sr-lang>` : html`<sr-lang key="standard_label">standard_label</sr-lang>`}
              </span>
          ...
          <div class="action-container">
            <span class="hidden-sm hidden-xs sr-only">
              ${this.rubric.metadata.public ? html`<sr-lang key="revoke_label">revoke_label</sr-lang>` : html`<sr-lang key="share_label">share_label</sr-lang>`}
            </span>
  ...
  cloneRubric(e) {
    e.stopPropagation();
    this.dispatchEvent(new CustomEvent("clone-rubric", {
      detail: this.rubric,
      bubbles: true,
      composed: true
    }));
  ...
  updateRubricTitle(e) {
    this.updateRubricOptions.body = JSON.stringify([{
      "op": "replace",
      "path": "/title",
      "value": e.detail
    }]);
    fetch(`/rubrics-service/rest/rubrics/${this.rubric.id}`, this.updateRubricOptions).then(r => {
      if (r.ok) {
