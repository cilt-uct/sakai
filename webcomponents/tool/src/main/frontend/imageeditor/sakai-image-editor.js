...
import Cropper from "../assets/cropperjs/dist/cropper.esm.js?version=9c647cc0";
import { cropperStyles } from "./cropperStyles.js?version=9c647cc0";
export class SakaiImageEditor extends SakaiDialogContent {
  ...
  filePicked(e) {
    ...
    this.cropper.getCroppedCanvas().toBlob(blob => {
      ...
      this.dispatchEvent(new CustomEvent("image-edited", {
        detail: {
          url: url,
          blob: blob
        },
