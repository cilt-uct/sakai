import { SakaiElement } from "./sakai-element.js?version=a82ac356?version=9c647cc0";
import { html } from "./assets/lit-html/lit-html.js?version=a82ac356?version=9c647cc0";
  ...
  constructor() {
    ...
    window.addEventListener('message', e => {
      try {
        ...
        if (allow_resize != "yes") return; // The message is from our frame
