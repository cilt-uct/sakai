import { LitElement, html, css } from "../assets/lit-element/lit-element.js?version=9c647cc0";
import "../assets/flatpickr/dist/flatpickr.min.js?version=9c647cc0";
...
import { flatpickerStyles } from "./flatpicker-styles.js?version=9c647cc0";
import "../assets/flatpickr/dist/plugins/confirmDate/confirmDate.js?version=9c647cc0";
/**
  ...
  attachPicker() {
    ...
    const config = {
      ...
      plugins: [new confirmDatePlugin({
        confirmIcon: `<sakai-icon type"add"></sakai-icon>`,
        confirmText: "Ok"
      })],
      ...
      onChange(selectedDates) {
        self.dispatchEvent(new CustomEvent("datetime-selected", {
          detail: {
            epochMillis: selectedDates[0].getTime()
          },
          bubbles: true
        }));
      }
